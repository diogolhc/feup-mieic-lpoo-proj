...
public class CropFieldTest {
    ...
    @BeforeEach
    void setUp() {
        this.field = new CropField(new Position(4, 5));
    }

    @Test
    void defaultState() {
        Assertions.assertTrue(this.field.getState() instanceof NotPlanted);
    }

    @Test
    void getUntraversableRegion() {
        Region region = this.field.getUntraversableRegion();
        ...
        this.field = new CropField(new Position(6, 6));
        region = this.field.getUntraversableRegion();
    ...
    void getGrowthStage() {
        ...
        Assertions.assertSame(growthStage, this.field.getCropGrowthStage());
    }
}
