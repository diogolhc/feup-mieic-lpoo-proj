...
class RainyControllerTest {
    ...
    @BeforeEach
    void setUp() {
        this.weatherController = new RainyController(1);
    ...
    void updateWeatherSunny() {
        this.weatherController.updateWeather(farmController, weather, 1, 0.09, 0);
    ...
    void updateWeatherCloudy() {
        this.weatherController.updateWeather(farmController, weather, 1, 0.39, 1);
    ...
    void updateWeatherThunderstorm() {
        this.weatherController.updateWeather(farmController, weather, 1, 0.49, 0);
